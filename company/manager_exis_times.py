...
<head>
    ...
    <title>Manager existing timeSheet</title>
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12"><br>
                            <h4 style="color: green;"> EXISTING TIMESHEET </h4><br></br>
                           <div class="table" style=" box-shadow: -3px -3px 8px 1px rgb(174, 159, 245);" >
                             <table border='2' class="table table-responsive table-bordered  table-hover" style="background-color:#ebf8f6; ">
                              <thead style="background-color: rgb(152, 218, 248);">
                                    <tr>
                                    <th>S.NO</th> <th> Date</th> <th>Day</th>
    ...
    print("""
                                <tbody>
                                    <tr>
                                        ...
                                        <td>%s</td>
                                    </tr>"""%(i[0],i[5],i[6],i[7],i[8],i[9],i[11],i[10]))
print("""
