...
print("""
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12"><br>
                            <h4 style="color: green;"> EXISTING HISTORY</h4><br>
                                   <div class="row">
                             ...
                             <table border='2' class="table table-responsive table-bordered  table-hover" style="background-color:#ebf8f6; ">
                                <thead style="background-color: rgb(152, 218, 248);">
                                        <tr>
                                            ...
                                            <th>Experience</th>  <th>Department</th> <th>Role</th>
...
if name and psearch !=None:
        ...
        q2= """select * from empreg where role='executive' and firstname='%s'  """%(name)
        cur.execute(q2)
        rec2=cur.fetchall()
        ...
        for i in rec2:
            ...
            print("""
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>%s</td>  <td>%s</td><td>%s</td>
                                                 <td>%s</td> <td>%s</td><td>%s</td>
                                                <td>%s</td> <td>%s</td>"""%(i[1],i[2],i[3],i[4],i[5],i[6],i[7],i[8],i[9],i[10],i[11],i[13],i[14],i[15],i[16],i[17]))

            q3= """select max(totalhours) from timesheet where role='executive' and empid='%s' and name='%s' """%(peid,name)
            cur.execute(q3)
            rec3=cur.fetchall()
            ...
            q4= """select max(totalleave) from leavet where role='executive' and eid='%s' and name='%s' """%(peid,name)
            cur.execute(q4)
            rec4=cur.fetchall()
    ...
    q2= """select * from empreg where role='executive'  """
    cur.execute(q2)
    rec2=cur.fetchall()
    ...
    for i in rec2:
        ...
        q3= """select max(totalhours) from timesheet where role='executive' and empid='%s' """%(peid)
        cur.execute(q3)
        rec3=cur.fetchall()
        ...
        q4= """select max(totalleave) from leavet where role='executive' and eid='%s' """%(peid)
        cur.execute(q4)
        rec4=cur.fetchall()
