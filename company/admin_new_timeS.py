...
q= """select * from timesheet where role='manager' and status='new'"""
cur.execute(q)
rec=cur.fetchall()
...
print("""
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12"><br>
                            <h4 style="color: green;"> TIMESHEET FOR MANAGER</h4><br><hr>
                              ...
                              <thead style="background-color: rgb(152, 218, 248);">
                                    <tr>
                                        <th>S.NO</th> <th>Name</th> <th>Department</th> <th>Role</th> <th> Date</th> <th>Day</th>
                                         <th>Timing</th>  <th>Hours</th>  <th>work status</th> 
    ...
    print("""
                                <tbody>
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        <td><input type="text" value='%s' name='id' readonly style="border:none; width:30px ; background:transparent ;"></td>  <td>%s</td>  <td>%s</td>  <td>%s</td> <td>%s</td> <td>%s </td>
...
papproved=form.getvalue('approved')
...
if papproved != None:
    ...
    con.commit()
    print("""<script>
    location.href="admin_new_timeS.py";
     </script>""")
