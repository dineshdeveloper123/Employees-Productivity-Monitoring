...
print("""
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12"><br>
                            <h4 style="color: green;"> MANAGER HISTORY</h4><br>
                                   <div class="row">
...
if name and psearch !=None:
        ...
        q2= """select * from empreg where role='manager' and firstname='%s'  """%(name)
        cur.execute(q2)
        rec2=cur.fetchall()
        ...
        for i in rec2:
            ...
            q3= """select max(totalhours) from timesheet where role='manager' and empid='%s' and name='%s' """%(peid,name)
            cur.execute(q3)
            rec3=cur.fetchall()
            ...
            q4= """select max(totalleave) from leavet where role='manager' and eid='%s' and name='%s' """%(peid,name)
            cur.execute(q4)
            rec4=cur.fetchall()
    ...
    q2= """select * from empreg where role='manager'  """
    cur.execute(q2)
    rec2=cur.fetchall()
    ...
    for i in rec2:
        ...
        q3= """select max(totalhours) from timesheet where role='manager' and empid='%s' """%(peid)
        cur.execute(q3)
        rec3=cur.fetchall()
        ...
        q4= """select max(totalleave) from leavet where role='manager' and eid='%s' """%(peid)
        cur.execute(q4)
        rec4=cur.fetchall()
