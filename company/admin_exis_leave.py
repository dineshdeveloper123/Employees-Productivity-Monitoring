...
q="""select * from leavet where (status='Approve' or status='Reject') and role='manager'  """
cur.execute(q)
rec=cur.fetchall()
print("""
<!DOCTYPE html>
                            ...
                            <div class="table" style=" box-shadow: -3px -3px 8px 1px rgb(174, 159, 245);" >
                             <table border='2' class="table table-responsive table-bordered  table-hover" style="background-color:#ebf8f6; ">
                               <thead style="background-color: rgb(152, 218, 248);">
                                    ...
                                    <th>No.of Days</th> <th>Leave Reason</th> <th>Total leave</th> <th>Acknowledgement</th>
                                </tr>
                                </thead>""")
...
for i in rec:
    print("""
                                <tbody>
                                   ...
                                   """%(i[0],i[2],i[3],i[4],i[5],i[5],i[9],i[10],i[11],i[12]))
