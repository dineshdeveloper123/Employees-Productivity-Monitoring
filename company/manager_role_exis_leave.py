...
q2= """select * from leavet where role='executive' and department='%s' and (status='Approve' or status='Reject')"""%(dep)
cur.execute(q2)
rec2=cur.fetchall()
...
<head>
    ...
    <title>Manager Role exis leave</title>
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12"><br>
                            <h4 style="color: green;"> EXISTING LEAVE </h4><br><br>
                            <div class="table" style=" box-shadow: -3px -3px 8px 1px rgb(174, 159, 245);" >
                             <table border='2' class="table table-responsive table-bordered  table-hover" style="background-color:#ebf8f6; ">
                              <thead style="background-color: rgb(152, 218, 248);" >
                                    ...
                                    <th>No.of Days</th> <th>Leave Reason</th> <th>Status</th><th>Total Leave</th>
                                </tr>
                                </thead>""")
...
for i in rec2:
    print("""
                                ...
                                </tbody>"""%(i[0],i[2],i[3],i[4],i[5],i[6],i[9],i[10],i[12],i[11]))
