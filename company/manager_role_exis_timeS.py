...
q2= """select * from timesheet where role='executive' and department='%s' and (status='Approved' or status='Reject')"""%(dep)
cur.execute(q2)
rec2=cur.fetchall()
...
<head>
    ...
    <title>role existing timeSheet</title>
...
print("""
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12"><br>
                            <h4 style="color: green;"> EXISTING TIMESHEET FOR EXECUTIVE</h4><br><hr>
                             ...
                             <thead  style="background-color: rgb(152, 218, 248);">
                                    <tr>
                                        <th>S.NO</th><th>Name</th><th>Department</th><th>Role</th> <th> Date</th> <th>Day</th>
                                         <th>Timing</th><th>Hours</th>  <th>Work status</th>  <th>Status</th> 
                                         <th>Total Hours</th> 
                                    </tr>
                                </thead>""")
...
for i in rec2:
    print("""
                               ...
                               """%(i[0],i[2],i[3],i[4],i[5],i[6],i[7],i[8],i[9],i[11],i[10]))
