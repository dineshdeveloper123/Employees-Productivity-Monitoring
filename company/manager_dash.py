...
print("""
            <main class="content px-3 py-2">
                ...
                <div class="col-4"><br><br><center>
                  <h4 style="color: rgb(118, 59, 59)"><B>WeLcOmE Manager</B></h4><br>
                  <img src="media/manager.jpg" class="rounded-circle" height="180px" style="box-shadow: 2px 2px 8px 2px rgb(70, 59, 81);">
                  <br><br>
