...
q="""select * from announcement where status='sent' """
cur.execute(q)
rec=cur.fetchall()
aid=rec[0][0]
...
print("""
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12"><br>
                            <h4 style="color: green;">1.EXISTING ANNOUNCEMENT</h4><br><br>
                                ...
                                <thead style="background-color: rgb(152, 218, 248);">
                                    <tr>
                                        <th>S.NO</th> <th>Announcement Date</th> <th> Department</th> <th>Subject</th>
                                         <th>Message</th>   <th>Acknowledgement</th>
                                    </tr>
                                </thead>""")
    ...
    print("""
                                ...
                                <form method="post" enctype="multipart/form-data" > 
                                    <tr>
                                        ...
                                        <td>%s</td> <td><input type="submit" class="btn btn-secondary" value="Cancel" name="cancel"></td>
                                    </tr>
                                    </form>""" % (i[0],i[1],i[2],i[3],i[4]))
...
pcancel=form.getvalue("cancel")

if pcancel != None:
    q="""update announcement set status='%s' where status='sent' and id='%s' """%(pcancel,aid)
    cur.execute(q)
    con.commit()
    print("""
    <script>
    location.href='admin_exis_anno.py' ;
    </script>""")

print("""  <hr> <h4 style="color: green;">2. ANNOUNCEMENT HISTORY</h4><br>
                    <div class="table">
...
q="""select * from announcement where status='cancel' """
cur.execute(q)
rec1=cur.fetchall()
