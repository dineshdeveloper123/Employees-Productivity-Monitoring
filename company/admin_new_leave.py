...
q= """select * from leavet where role='manager' and status='new'"""
cur.execute(q)
rec=cur.fetchall()
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12"><br>
                            <h4  style="color: green;"> NEW LEAVE </h4><br><br>
                                ...
                                <tbody>
                                    <tr>
                                      <form class="form-group" method="post" enctype="multipart/form-data">
                                         <td> <input type="text" class="form-control" value='%s' name="id" readonly style="border:none; background:transparent; width:30px"></td>
...
if papprove != None:
    ...
    print("""
    <script>
    location.href='admin_new_leave.py' ;
    </script>""")

preject=form.getvalue("reject")
if preject != None:
    pid=form.getvalue("id")
    q="""update leavet set status='%s' where id='%s' """%(preject,pid)
    cur.execute(q)
    con.commit()
